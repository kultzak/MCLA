    ...
    def run(self):
        try:    
            subprocess.call(['make config'], cwd = path.join(here, 'src', 
                            'MCLA', 'Hypergraph_Partitioning', 'metis-5.1.0'),
                            shell = True)
...
setup(name = 'MCLA',
      ...
      platforms = ('Any',),
      install_requires = ['numexpr>=2.4', 'numpy>=1.9.0', 'scipy', 'sklearn', 'setuptools', 'metis', 'tables'],
      ...
      keywords = "aggregation clustering consensus consensus-clustering MCLA "
